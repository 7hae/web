...
;?>
	...
	<tr>
		<td>页内锚点链接：</td>
		<td><input type="text" name="mao" value="" id="mao" size='30' />没有可不填
		</td>
	</tr>
	
	<tr>
		<td>标题【副】:</td>
		<td><input type="text" name="title2" id="title2" size='60' />
		...
		<td colspan="2">
			<div id="btn" style="display:none">
				<ul>
					...
					<li><span>链接打开方式：</span>
					<input type="radio" name="news_window" onchange="get_link_type(this)" value="1" checked />新窗口
					<input type="radio" name="news_window" onchange="get_link_type(this)" value="0" />原窗口
					<input type="hidden" id="news_window" value="1" />
					</li>
